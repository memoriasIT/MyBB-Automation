...
if loginsystem.useKeyring and loginsystem.alreadySaved:
    YourPW = keyring.get_password("MyBBScraper", loginsystem.email)
else:
...
DATA = {
    ...
    "submit": "Login",
    "quick_login": "1",
    "quick_username": loginsystem.email,
...
def main():
    ...
    """ % (loginsystem.version) + Style.RESET_ALL)
        login()
        time.sleep(loginsystem.RefreshRate)
main()
